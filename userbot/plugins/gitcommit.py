...
async def download(event):
    ...
    if Var.GIT_REPO_NAME is None:
        ...
        return
    royalbot = await edit_or_reply(event, "Processing ...")
    ...
    try:
        ...
        await royalbot.edit("Committing to Github....")
        await git_commit(downloaded_file_name, royalbot)


async def git_commit(file_name, royalbot):
    content_list = []
    ...
    if create_file == True:
        ...
        try:
            ...
            await royalbot.edit("Cannot Upload Plugin")
    else:
        return await royalbot.edit("`Committed Suicide`")
